...
<head>
    ...
    <title>Subscription Form | AAmple-G's Food</title>
  ...
  <div class="wrapper">
    ...
    if(isset($_POST['subscribe'])){ //if subscribe btn clicked
      ...
      if(filter_var($userEmail, FILTER_VALIDATE_EMAIL)){ //validating user email
        $subject = "Thanks for Subscribing us - AAMple-G's Food";
        $message = "Thanks for subscribing . You'll always receive updates from us. And we won't share and sell your information.";
        $sender = "From: aample.g.food8773@gmail.com";
